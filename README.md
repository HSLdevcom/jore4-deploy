...
- [Scripts](#scripts)
  - [Provisioning](#provisioning)
    ...
    - [4. Setting up a certificate](#4-setting-up-a-certificate)
...
### 4. Setting up a certificate

TODO when decided whether to use automation or App Service Certificate
...
Note that when first provisioning this, there is no certificate attached, neither are any listeners
