...
information on the Azure Portal), then it's best to use the PATCH endpoint for fixing the key-vault
binding as the PUT endpoint does not work in every case.
